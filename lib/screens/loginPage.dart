...
//     List<LoginModel> users = await apiService.loginuser();
//     LoginModel? user = users.firstWhere(
//       (user) =>
//           user.phoneNumber == _usernameController.text &&
...
//         SnackBar(content: Text('login_page.all_verification'.tr)),
//       );
//     }
//   }
